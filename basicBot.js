...
(function() {
    ...
    */
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get('http://fatalgamert.esy.es/blacklist/langIndex.json', function(json) {
    ...
    var basicBot = {
        ...
        name: 'basicBot',
        loggedInID: null,
        scriptLink: 'http://fatalgamert.esy.es/blacklist/basicBot.js',
        ...
        settings: {
            ...
            commandLiteral: '!',
            blacklists: {
                NSFW: 'http://fatalgamert.esy.es/blacklist/NSFWlist.json',
                OP: 'http://fatalgamert.esy.es/blacklist/OPlist.json',
                BANNED: 'http://fatalgamert.esy.es/blacklist/BANNEDlist.json'
            }
        },
        room: {
            name: null,
